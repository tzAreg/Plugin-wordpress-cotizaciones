<?php
    ...
    if ($count > 0){
        $sql1 = "SELECT * FROM wp_rates_air WHERE rate_country = '$country'";
        ...
        if($resultConsulta1->num_rows > 0){
            ...
            if (empty($newWeight)){
                $update = "UPDATE wp_rates_air SET $weight = '$price' WHERE rate_country = '$country'";
            ...
            $query = "INSERT INTO wp_rates_air(aid, rate_country, $weight) VALUES ('', '$country', '$price')";
        ...
        if ($conexion->query($sql1) === TRUE){
            ...
            if($count1 > 0){
                ...
                $query = "INSERT INTO wp_rates_air(aid, rate_country) VALUES ('', '$country')";
                $conexion->query($query);
